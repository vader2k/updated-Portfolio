...
const Hero = () => {
  return (
    <div className="py-5 px-3 h-[100vh] sm:mt-40">
      <div className='flex ml-28 mb-24 relative z-20 sm:ml-[20rem] md:ml-[40rem]'>
      ...
      <div className="leading-[2.7rem] sm:leading-[3.5rem]">
        ...
        <h1>DESIGNER <span className="text-[1rem] sm:text-[2rem] text-golden">&</span></h1>
        <h1>DEVELOPER</h1>
      </div>
      <p className='flex flex-col py-20 sm:mt-10 sm:text-[1.6rem] font-Raleway line sm:ml-[100px]'>
