...
const Healthstarks = () => {
  return (
    <div className='py-10 px-3 h-[100vh]'>
      {<Link to='/'>
      ...
      <div className='mt-32 border-t border-golden py-3 w-[90%] m-auto'>
        <div className='flex flex-col gap-5'>
          <p>Frontend Development</p>
          <button className='flex items-center gap-5'>see case <BsArrowUpRight/> </button>
        </div>
      </div>
    </div>
  )
